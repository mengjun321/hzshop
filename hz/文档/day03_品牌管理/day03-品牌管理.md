...
然后再次发起请求：
 ...
 ![1561869017009](assets\1561869017009.png)
...
参数格式：
 ...
 ![1561869126966](assets\1561869126966.png)
...
![1561869473913](assets\1561869473913.png)

![1561869506826](assets\1561869506826.png)
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>hz-upload</artifactId>
...
![1561869791177](assets\1561869791177.png)
...
我们通过Postman工具来测试：
 ...
 ![1561875161995](assets\1561875161995.png)

结果：

 ![1526197027688](assets\1561875194970.png)

去目录下查看：

 ![1526197060729](assets\1561875224939.png)
...
```nginx 
	server {
        ...
        location / {
			proxy_pass http://192.168.1.110:10010;
			proxy_connect_timeout 600;
			proxy_read_timeout 600;
        }
    }
...
![1561908541080](assets\1561908541080.png)
...
这是因为我们并没有任何服务器对应image.hz.com这个域名。。
...
@SpringBootTest(classes = HzUploadService.class)
...
![1561910125280](assets\1561910125280.png)
...
通过Postman测试：
 ...
 ![1561910165921](assets\1561910165921.png)
...
这是因为我们图片是上传到虚拟机的，ip为：192.168.1.151

因此，我们需要将image.hz.com映射到192.168.1.151
